insert into customers (id, first_name, last_name, tax_category_percents)
values(1, 'Tony', 'Stark', array[10, 6, 20, 20, 20]);
insert into customers (id, first_name, last_name, tax_category_percents)
values(2, 'Steve', 'Rogers', array[0, 0, 0, 0, 0]);
insert into customers (id, first_name, last_name, tax_category_percents)
values(3, 'Peter', 'Parker', array[0, 0, 0, 0, 0]);
insert into customers (id, first_name, last_name, tax_category_percents)
values(4, 'Thor', 'Odinson', array[0, 0, 0, 0, 0]);
...
insert into products (id, name, product_type, category_id) values(1, 'Tap water', 1, 2);
insert into products (id, name, product_type, category_id) values(2, 'Juice', 1, 2);
insert into products (id, name, product_type, category_id) values(3, 'Rum', 2, 3);
insert into products (id, name, product_type, category_id) values(4, 'Soup', 0, 4);
